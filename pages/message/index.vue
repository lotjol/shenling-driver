...
<template>
  <view class="page-container">
    ...
    <button v-lazy-show="show">
      <!-- <test></test> -->
    </button>
    <!-- <view v-lazy-show="false" >
      <demo></demo>
    </view> -->
    ...
    >
      <view class="scroll-view-wrapper">
        ...
        <view v-if="tabsData[0].items.length === 0" class="message-blank"
          >暂无消息</view
        >
      </view>
    </scroll-view>
    ...
    >
      <view class="scroll-view-wrapper">
        ...
        <view v-if="tabsData[1].items.length === 0" class="message-blank"
          >暂无消息</view
        >
      </view>
    </scroll-view>
